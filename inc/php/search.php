...
$expire = 	86400; // 24h - thời gian tạo cache mới
$file	= 	"tim-kiem.txt";
	...
	foreach($lines as $line){
		if(strpos($line, $search) !== false){
			...
			if($i<=5) {
				...
				$show			.=	"<li class=\"singer_li\"><a href=\"$url_film\"><img width=\"35\" height=\"35\" class=\"search-img\" src=\"$film_img\"><p>$film_name ($film_year)</p><span>$film_name_real</span></a></li>";
			}
		}
	}
	if($show) {
	...
	foreach($linesz as $linez){
		if(strpos($linez, $search2) !== false){
			...
			if($x<=5) {
				...
				$showz			.=	"<li class=\"singer_li\"><a href=\"$url_actor\"><img width=\"35\" height=\"35\" class=\"search-img\" src=\"$actor_img\"><p>$actor_name</p></a></li>";
			}
		}
	}
	if($showz) {
